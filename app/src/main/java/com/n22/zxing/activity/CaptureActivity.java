...
import com.n22.zxing.camera.CameraManager;
import com.n22.zxing.decode.DecodeThread;
import com.n22.zxing.utils.BeepManager;
import com.n22.zxing.utils.CaptureActivityHandler;
import com.n22.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends AppCompatActivity implements
    ...
    public static final String SCAN_MSG = "scan_msg";
    ...
    public static void start(Fragment fragment, int code, String id) {
    ...
    private void handleText(String text) {
        ...
        bundle.putString(SCAN_MSG, text);
        bundle.putString(LOCAL_ID, local_id);
